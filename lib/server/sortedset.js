...
exports.zpopmin = function(key, count, callback) {
  this.zrangebyscore(key, '-inf', '+inf', 'WITHSCORES', 'LIMIT', 0, count === 'function' ? 1 : count, function (err, a) {
    if (err) {
      helpers.callCallback(typeof count === 'function' ? count : callback, err);
      return;
    }
    ...
    helpers.callCallback(typeof count === 'function' ? count : callback, null, [a[0], a[1]]);
  });
}
